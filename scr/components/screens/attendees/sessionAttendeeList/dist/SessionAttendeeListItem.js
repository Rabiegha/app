...
var ListItem = react_1["default"].memo(function (_a) {
    ...
    var _c = react_1.useState(initialSwitchState), isCheckedIn = _c[0], setIsCheckedIn = _c[1];
    ...
    return (react_1["default"].createElement(react_native_1.TouchableWithoutFeedback, { onPress: handleItemPress, accessible: false },
